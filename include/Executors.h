...
#include <Preferences.h> //used by configuration
...
ECCLES_API {
    ...
    class Conversation : public Executor {
        ...
        //we needed a copy of the command object so we can send back our requested configuration back as result
    ...
    class ExecutorManager {
        ...
        */
        ...
        void cleanup(); //not sure we need this but just in case
    };
